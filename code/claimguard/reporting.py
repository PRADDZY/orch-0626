...
def write_markdown_report(
    ...
    content = "\n".join(
        [
            ...
            "",
            f"- Approximate model calls for full processing: `{ops['approx_model_calls']}`",
            f"- Approximate input token usage: `{ops['approx_input_tokens']}`",
            f"- Approximate output token usage: `{ops['approx_output_tokens']}`",
            f"- Number of images processed during this run: `{ops['images_processed']}`",
